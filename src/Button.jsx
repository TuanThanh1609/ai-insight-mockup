...
export function Button({
  ...
  const variants = {
     ...
     */
    primary:
      'bg-[#fa6e5b] text-white hover:brightness-110 active:brightness-95 rounded-md shadow-[--shadow-sm] hover:shadow-[--shadow-md]',
     ...
     */
    tertiary:
      'bg-tertiary text-on-tertiary hover:brightness-110 active:brightness-95 rounded-md shadow-[--shadow-sm] hover:shadow-[--shadow-md]',
     ...
     */
    secondary:
      'bg-primary text-on-primary hover:brightness-110 active:brightness-95 rounded-md shadow-[--shadow-sm] hover:shadow-[--shadow-md]',
     ...
     */
    ghost:
      'bg-transparent text-on-surface-variant hover:bg-surface-container-low active:bg-surface-container-lowest rounded-md border border-transparent',
     ...
     */
    'ghost-outline':
      'bg-transparent text-on-surface-variant hover:bg-surface-container-low active:bg-surface-container-lowest rounded-md border border-[var(--color-outline-variant)]',

    /**
     * Danger: Error container for destructive actions
     */
    danger:
      'bg-error-container text-on-error-container hover:brightness-95 active:brightness-90 rounded-md',

    /**
     * AI Action: Vibrant Blue gradient — AI-powered recommendations
     */
    'ai-action':
      'bg-tertiary text-on-tertiary hover:brightness-110 active:brightness-95 rounded-md shadow-[--shadow-sm] hover:shadow-[--shadow-md] gap-1.5',
  };
