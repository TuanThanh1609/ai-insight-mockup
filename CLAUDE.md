...
## Bug & Decision Memory (last 5)

- **2026-04-07** — Bug: `col.key` → `col.id` trong ConversationTable (TEMPLATES columns dùng `id`)
- **2026-04-07** — Bug: Wrong path `./components/...` → `../components/...` trong InsightV3Page.jsx
- **2026-04-07** — Decision: Mỗi insight = 1 bảng riêng, KHÔNG cộng dồn columns
- **2026-04-07** — Decision: `insight-v3-data.js` là single source of truth cho TEMPLATES
- **2026-04-07** — Decision: InsightSelectDropdown chỉ hiện khi có template active, bỏ "Tất cả các cột"
