...
- **Thay đổi:**
  - Thêm tab "Tổng quan | Gợi ý tối ưu" chuyển giữa 2 bảng
  - **Bảng Tổng quan** (8 cột): Chiến dịch | Chi tiêu | Hội thoại | CvR | Doanh thu | ROAS | Đơn | Chất lượng — click row → mở AIInsightPanel + DailyDetailChart
  - **Bảng Gợi ý tối ưu** (4 cột): Chiến dịch | AI Gợi ý | Phân tích | Chỉ số — expand row → chi tiết metrics (junk rate, quality rate, spam) + nút hành động (Tăng +20% / Tắt ngay)
  - Bảng "Gợi ý tối ưu" sort theo thứ tự: Tăng → Giữ → Giảm → Tắt

---

### [Tiếp tục cập nhật sau mỗi session...]
...
└── src/
    ...
    └── components/
        ...
        └── insight/
            ...
            ├── InsightDetailModal.jsx       ← Track A
